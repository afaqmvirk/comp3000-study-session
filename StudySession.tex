...
\mcquestion{Which of the following statements are true? Select all that apply. You may also want to justify your choice behing each decision.}{
...
\question Explain the difference between multiprogramming and multiprocessing. Include what each term means, what hardware support is required, and an example scenario where each is useful.
